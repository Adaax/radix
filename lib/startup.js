...
window.onload = function()
{
	...
	rscript_check.style.visibility = "hidden";

	rscript_check.checked = false;
	...
	asm_check.style.visibility = "hidden";

	asm_check.checked = true;
...
compile_program = function(run_program)
{
	...
	if (compile_flag == 1)
	{
		var program_name = asm_file.substring(asm_file.lastIndexOf("\\") + 1, asm_file.length - 4);
